            ...
            <div class="card-body">
              ...
              <!-- End Default Table Example -->
                <form action="" method="post">
                    ...
                    <br><br>
                    <button type="submit" class="btn-checkout btn" name="submit">Checkout</button>
                    <button class="btn-del btn" onclick="return confirm('Apakah anda yakin ingin menghapus semua produk di keranjang?')">
