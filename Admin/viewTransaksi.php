                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else : ?>
                                ...
                                <a href="rejectTransaksi.php?idTransaksi=<?= $transaksi["idTransaksi"]; ?>" class="btn btn-danger" onclick="return confirm('Yakin menolak pesanan dengan id <?= $transaksi["idTransaksi"]; ?>?');">Reject</a>
                            <?php endif; ?>
                        </td>
                        <td>
