                ...
                <div class="col">
                    ...
                    <div class="container mt-3">
                        <div class="row align-items-center">
                            <center>
                                <img src="../img/logoMC.png" width="60px" class="mb-1">
                                <div class="text-invoice col-md-10">
                                    <h2 class="mb-1">MEDI<span>CARE</span></h2>
                                    <h4 class="mb-2">Invoice Belanja <?= $detailTransaksi["username"]; ?></h4>
                                </div>
                            </center>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card col">
                            ...
                            <div class="mt-3 text-end">
                                <h5>Pemilik Toko</h5>
                                <img src="../img/ttd2.png" alt="Tanda Tangan" style="width: 200px; height: 200px;">
