            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card-login mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Selamat Datang di Medicare!</h5>
                    <p class="text-center small">Buat akun pribadimu</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <p class="small mb-0">Login sebagai Admin? <a href="loginAdmin.php">Login Admin</a></p>
